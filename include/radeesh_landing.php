...
<a-scene keyboard-shortcuts vr-mode-ui id="fabio_pagina">
    ...
    <a-image id="radeesh_marker" class="marker" src="#marker_1" width="1" height="1" position="0 1 -2" scale="0.2 0.2 0.2" rotation="0 0 0"> <!--Marker Fabio-->    
    </a-image>
    <a-image id="chi_siamo_landing_marker" class="marker cd-btn cd-modal-trigger nascondi" src="#marker_1" width="1" height="1" position="2 1 -1" scale="0.2 0.2 0.2" rotation="10 -75 0" data-href="index.php?pag=chi_siamo"> <!--Marker Chi Siamo-->    
    </a-image>
