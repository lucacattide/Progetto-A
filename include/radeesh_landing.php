<!--Inizio Scena Radeesh-->

<a-scene keyboard-shortcuts vr-mode-ui id="fabio_pagina">

	<!--Inizio Assets-->
    
    <a-assets>
    
    	<img id="radeesh_sfondo" src="img/radeesh_sfondo.png" alt=""> <!--Sfondo-->
    ...
    <a-sky src="#radeesh_sfondo" transparent="true" rotation="0 -80 0"> <!--Sfondo-->
    </a-sky>
    ...
    <a-image id="radeesh_marker" class="marker" src="#marker_1" width="1" height="1" position="0 1 -2" scale="0.2 0.2 0.2" rotation="0 0 0" look-at="#camera"> <!--Marker Fabio-->    
    </a-image>
    <a-image id="chi_siamo_landing_marker" class="marker cd-btn cd-modal-trigger nascondi" src="#marker_1" width="1" height="1" position="2 1 -1" scale="0.2 0.2 0.2" rotation="10 -75 0" data-href="index.php?pag=chi_siamo" look-at="#camera"> <!--Marker Chi Siamo-->    
    </a-image>
...
<!--Inizio Layout Radeesh-->

<!--Inizio Links Associativi-->

<!--Inizio Radeesh-->

<section id="radeesh" class="scheda secondo_livello nascondi" rel="radeesh">
