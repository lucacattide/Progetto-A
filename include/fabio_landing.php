...
<a-scene keyboard-shortcuts vr-mode-ui id="fabio_pagina">
	...
	<!--Inizio Assets-->
     ...
     <a-assets>
    	...
    	<img id="fabio_sfondo" src="img/fabio_sfondo.png" alt=""> <!--Sfondo-->
    ...
    <a-sky src="#fabio_sfondo" transparent="true" rotation="0 -80 0"> <!--Sfondo-->
    </a-sky>
    ...
    <a-image id="fabio_marker" class="marker" src="#marker_1" width="1" height="1" position="0 1 -2" scale="0.2 0.2 0.2" rotation="5 12 0"> <!--Marker Fabio-->    
    </a-image>
    <a-image id="chi_siamo_landing_marker" class="marker cd-btn cd-modal-trigger nascondi" src="#marker_1" width="1" height="1" position="2 0 -2" scale="0.2 0.2 0.2" rotation="0 0 0" data-href="index.php?pag=chi_siamo"> <!--Marker Chi Siamo-->    
    </a-image>
...
<section id="fabio" class="scheda secondo_livello nascondi" rel="fabio">
