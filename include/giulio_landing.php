...
<a-scene keyboard-shortcuts vr-mode-ui id="giulio_pagina">

	<!--Inizio Assets-->
    
    <a-assets>
    
    	<img id="giulio_sfondo" src="img/giulio_sfondo.png" alt=""> <!--Sfondo-->
    ...
    <a-sky src="#giulio_sfondo" transparent="true" rotation="0 -90 0"> <!--Sfondo-->
    </a-sky>
    ...
    <a-image id="giulio_marker" class="marker" src="#marker_1" width="1" height="1" position="0 1 -2" scale="0.2 0.2 0.2" rotation="0 0 0"> <!--Marker Fabio-->    
    </a-image>
    <a-image id="chi_siamo_landing_marker" class="marker cd-btn cd-modal-trigger nascondi" src="#marker_1" width="1" height="1" position="-2 1 -1" scale="0.2 0.2 0.2" rotation="10 45 0" data-href="index.php?pag=chi_siamo"> <!--Marker Chi Siamo-->    
    </a-image>
...
<!--Inizio Layout Giulio-->

<!--Inizio Links Associativi-->

<!--Inizio Giulio-->

<section id="giulio" class="scheda secondo_livello nascondi" rel="giulio">
